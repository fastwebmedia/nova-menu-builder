...
```bash
composer require Fastwebmedia/nova-menu-builder
```
...
public function tools()
{
    return [
        // ...
        new \Fastwebmedia\MenuBuilder\MenuBuilder(),
    ];
}
```
...
First, create a class that extends the `Fastwebmedia\MenuBuilder\Classes\MenuLinkable` class.
